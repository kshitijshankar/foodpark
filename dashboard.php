...
<head>
    ...
    <title>FoodPark-Dashboard</title>
    <!-- Bootstrap Core CSS -->
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        <!-- Logo icon -->
                        <b><img src="images/logo.png" alt="homepage" class="dark-logo" width="100" height="44"/></b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <!-- <span><img src="images/logo.png" alt="homepage" class="dark-logo" width="44" height="44"/></span> -->
                    </a>
                </div>
                <!-- End Logo -->
