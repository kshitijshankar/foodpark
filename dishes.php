        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/food-picky-logo.png" width="100";height="40"> </a>
...
?>								  
            ...
            <div class="container">
                ...
                <div class="bottom-footer abc">
                    <div class="row">
                        <div class="col-6 address color-gray">
                        <a href="#"> <img src="images/food-picky-logo.png" class="img-rounded" alt="Footer logo" > </a> <span>Order Delivery &amp; Take-Out </span> </div>
                        <div class="col-6 additional-info color-gray">
                        <h5 class="xyz">Ⓒ All Right Resevered.</h5>
                            <span>@Kshitijshankar</span>
                        </div>
                    </div>
                </div>
                <!-- bottom footer ends -->
